    ...
    <div class="container mx-auto px-4 py-4">
      <div class="flex flex-col md:flex-row justify-between items-center">
        ...
        <nav class="hidden md:flex items-center space-x-8">
          <a href="#inicio" class="text-gray-700 hover:text-blue-600 font-medium transition">Inicio</a>
          <a href="#servicios" class="text-gray-700 hover:text-blue-600 font-medium transition">Servicios</a>
          <a href="#sobre-nosotros" class="text-gray-700 hover:text-blue-600 font-medium transition">Nosotros</a>
            ...
            <div class="bg-blue-50 p-2 rounded-lg">
              <a href="tel:+13059050376" 
                ...
                <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M20 15.5c-1.2 0-2.4-.2-3.6-.6-.3-.1-.7 0-1 .2l-2.2 2.2c-2.8-1.5-5.2-3.8-6.6-6.6l2.2-2.2c.3-.3.4-.7.2-1-.3-1.1-.5-2.3-.5-3.5 0-.6-.4-1-1-1H4c-.6 0-1 .4-1 1 0 9.4 7.6 17 17 17 .6 0 1-.4 1-1v-3.5c0-.6-.4-1-1-1zM5 6h1.5c.1 1.2.3 2.4.6 3.5L5.3 12c-.9-2.3-1.4-4.7-1.4-7.2 0-.3 0-.6.1-.8z"/>
                </svg>
                +1 (305) 905-0376
              </a>
      ...
      @if (menuOpen) {
        <div class="md:hidden mt-4 pb-4 border-t pt-4">
          <div class="flex flex-col space-y-4">
            ...
            <a href="#servicios" class="text-gray-700 hover:text-blue-600 font-medium py-2">Servicios</a>
            <a href="#sobre-nosotros" class="text-gray-700 hover:text-blue-600 font-medium py-2">Nosotros</a>
            <a href="#contacto" class="text-gray-700 hover:text-blue-600 font-medium py-2">Contacto</a>
          </div>
        </div>
      }
    </div>
