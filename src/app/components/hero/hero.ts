...
@Component({
  ...
  standalone: true,
  template: `
  <section class="relative bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 text-white pt-8 pb-12 md:pt-12 md:pb-20 px-4 overflow-hidden">
    ...
    <div class="absolute inset-0 opacity-5">
      ...
      <div class="absolute bottom-10 right-10 w-72 h-72 bg-blue-300 rounded-full mix-blend-multiply filter blur-xl"></div>
    </div>
    ...
    <div class="container mx-auto text-center relative z-10">
      ...
      <div class="mb-6">
        ...
        <p class="text-xl md:text-2xl font-light text-blue-100">Mantenimiento Submarino Profesional</p>
      </div>

      <!-- Descripción concisa -->
      <p class="text-lg md:text-xl mb-8 max-w-3xl mx-auto leading-relaxed">
        Expertos en <span class="font-bold text-yellow-300">mantenimiento de cascos</span>, inspecciones submarinas y reparaciones<br class="hidden md:block">
      ...
      <div class="mb-10">
        <div class="inline-flex items-center bg-white/10 backdrop-blur-sm rounded-full px-6 py-3 mb-6">
          ...
          <div class="text-left">
            ...
            <a href="tel:+13059050376" class="text-2xl font-bold hover:text-yellow-300 transition">305-905-0376</a>
          </div>
        </div>
      </div>
